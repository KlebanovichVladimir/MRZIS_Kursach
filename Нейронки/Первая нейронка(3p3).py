...
for data_type, true_data, pred_data, data_label in [
    ...
    plt.plot(pred_data[:, 0], pred_data[:, 1], label='Y(X) модель', linestyle='--', alpha=0.7)
    plt.xlabel('X')
    plt.ylabel('Y')
    ...
    plt.plot(pred_data[:, 0], pred_data[:, 2], label='Z(X) модель', linestyle='--', alpha=0.7)
    plt.xlabel('X')
    plt.ylabel('Z')
    ...
    plt.plot(pred_data[:, 1], pred_data[:, 2], label='Z(Y) модель', linestyle='--', alpha=0.7)
    plt.xlabel('Y')
    plt.ylabel('Z')
